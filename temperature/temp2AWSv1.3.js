...
device
  .on('connect', function() {
    ...
    timeout = setInterval( function() {
	    ...
	    device.publish('sdkTest/Temperature', JSON.stringify({ Temperature: currentTemp})); //publish temperature sensor data to AWS
...
server.get({path : path , version : '1.0.0'}, getSensors);
